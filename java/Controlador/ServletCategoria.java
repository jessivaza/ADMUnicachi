...
public class ServletCategoria extends HttpServlet {
 ...
 protected void graficoLis(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, JRException {
    System.out.println("Ingreso a la función");

    List<Categoria> lista = new CategoriaDAO().findAllCategoria();

    // Iterar sobre la lista para obtener la cantidad total de productos
    int cantidadProducto = lista.stream().mapToInt(Categoria::getCantidadProductos).sum();
