...
<html>
    ...
    <body>
        <div class="sidebar">
            ...
            <form action="ServletCategoria?accion=graficolis" method="post">
                <button tipye="sumit">grafico</button>
            </form>
        </div>
            ...
            <ul>
                ...
                <li><a href="#Clientes">Usuario</a></li>
            </ul>

            <li style="margin-top: 10px; display: flex; align-items: center; justify-content: center;text-align: center;">
                <a href="Ingresar.jsp" style="text-decoration: none; color: #333; font-weight: bold; display: flex; align-items: center;">
        ...
        var graficoPequeno = new Chart(ctx1, {
            ...
            options: {
                ...
                maintainAspectRatio: false
                    ...
                    var ctx2 = document.getElementById('graficoBarras').getContext('2d');
                    var graficoBarras = new Chart(ctx2, {
                        type: 'bar',
                        data: {
                            labels: ['Rojo', 'Verde', 'Azul', 'Morado', 'Amarillo', 'Naranja'],
                            datasets: [{
                                    ...
                                    backgroundColor: ['#FF6384', '#36A2EB', '#FFCE56', '#9370DB', '#FFD700', '#FFA500'],
                                    borderColor: ['#FF6384', '#36A2EB', '#FFCE56', '#9370DB', '#FFD700', '#FFA500'],
                                    borderWidth: 1
                                }]
                        },
                        options: {
            ...
            <table>
                ...
                <tbody>
                    <% 
                        ...
                        List<Producto> listaProductos = productoDAO.findAllProducto();
            ...
            <table>
                ...
                <tbody>
                    <% 
                        ...
                        List<Cliente> listaClientes = clienteDAO.findAllClientes();
